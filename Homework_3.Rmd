...
#mutate necessary in case you need to modify column that you will use to join shape # file and data file
...
shape.2.data@data <- merge(shape.data.2, practical.data, sort = FALSE)
